...
// 	algorithmic O(n)
// 	memory O(1)
class KidsWithTheGreatestNumberOfCandiesTests {
    ...
    void testCase1() {
        Assertions.assertArrayEquals(
                ...
                kidsWithCandies(new int[]{2, 3, 5, 1, 3}, 3).toArray()
        );
    }
    ...
    void testCase2() {
        Assertions.assertArrayEquals(
                ...
                kidsWithCandies(new int[]{4, 2, 1, 1, 2}, 1).toArray()
        );
    }
    ...
    void testCase3() {
        Assertions.assertArrayEquals(
                ...
                kidsWithCandies(new int[]{12, 1, 12}, 10).toArray()
        );
    }
